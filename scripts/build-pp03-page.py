...
main = r'''      <main id="main-content" itemprop="mainContentOfPage" itemscope itemtype="https://schema.org/Article">
        ...
        <header class="policy-hero">
          <div class="policy-hero__media" aria-hidden="true">
            <img
              itemprop="image"
              src="https://media.cwd-cdn.com/norm-for-mayor/vision/pp03-downtown-catalyst-2.jpg"
        ...
        <div class="policy-doc">
          <div class="container">
            ...
            <section class="policy-sheet" aria-labelledby="public-land-heading">
              ...
              <div class="policy-sheet__split policy-sheet__split--land policy-sheet__split--issue">
                <div class="policy-sheet__copy">
                ...
                <aside class="policy-site__highlight" aria-label="Initiative quote">
                  <blockquote>
                    <p>&ldquo;Public land should deliver more than one benefit. Parking, housing and commercial space can work together when they are planned as one project.&rdquo;</p>
                  </blockquote>
                  <cite>Norm Sandberg, announcing this initiative</cite>
                </aside>
              </div>
            </section>
            ...
            <section class="policy-site" aria-labelledby="ste-marie-heading">
              ...
              <div class="policy-materials" aria-labelledby="ste-marie-materials-heading">
                ...
                <h4 class="policy-materials__title" id="ste-marie-materials-heading">Concept materials &mdash; 140 Ste. Marie Street</h4>

                <figure class="policy-site__visual">
                  <a class="policy-materials__thumb" href="https://media.cwd-cdn.com/norm-for-mayor/vision/pp03/140-ste-marie-st.png" target="_blank" rel="noopener">
                    <img
                      src="https://media.cwd-cdn.com/norm-for-mayor/vision/pp03/140-ste-marie-st.png"
                      alt="Concept rendering for the 140 Ste. Marie Street downtown parking, housing and commercial project"
                      width="1323"
                      height="201"
                      loading="lazy"
                      decoding="async"
                ...
                <div class="policy-materials__grid" role="list">
                  <figure class="policy-materials__item policy-materials__item--wide" role="listitem">
                    <a class="policy-materials__thumb" href="https://media.cwd-cdn.com/norm-for-mayor/vision/pp03/council-board-presentation.jpg" target="_blank" rel="noopener">
                      <img
                        src="https://media.cwd-cdn.com/norm-for-mayor/vision/pp03/council-board-presentation.jpg"
                        alt="Council board concept presentation overview for the Second Street and Pine Street municipal parking lot project"
                        width="2550"
                        height="1650"
                        loading="lazy"
                        decoding="async"
